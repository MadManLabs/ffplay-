...
#define QSV_HAVE_CO2 0 //QSV_VERSION_ATLEAST(1, 6)
#define QSV_HAVE_CO3 0 //QSV_VERSION_ATLEAST(1, 11)

#define QSV_HAVE_TRELLIS 0 //QSV_VERSION_ATLEAST(1, 8)
#define QSV_HAVE_MAX_SLICE_SIZE 0//QSV_VERSION_ATLEAST(1, 9)
#define QSV_HAVE_BREF_TYPE      0//QSV_VERSION_ATLEAST(1, 8)

#define QSV_HAVE_LA    0// QSV_VERSION_ATLEAST(1, 7)
#define QSV_HAVE_LA_HRD 0//QSV_VERSION_ATLEAST(1,  11)
#define QSV_HAVE_ICQ    0//QSV_VERSION_ATLEAST(1, 8)
#define QSV_HAVE_VCM    0//QSV_VERSION_ATLEAST(1, 8)
#define QSV_HAVE_QVBR   0//QSV_VERSION_ATLEAST(1, 11)
